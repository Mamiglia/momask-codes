...
class EvaluatorModelWrapper(object):
    def __init__(self, opt):
        if opt.dataset_name == "HumanML3D" or opt.dataset_name == "Motion-X":
            opt.dim_pose = 263
    ...
    def get_co_embeddings(self, word_embs, pos_ohot, cap_lens, motions, m_lens):
        with torch.no_grad():
            ...
            m_lens = torch.div(m_lens, self.opt.unit_length)
    ...
    def get_text_embeddings(self, word_embs, pos_ohot, cap_lens, m_lens):
        with torch.no_grad():
            ...
            """Text Encoding"""
            text_embedding = self.text_encoder(word_embs, pos_ohot, cap_lens)[align_idx]
